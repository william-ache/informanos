...
function HomeContent() {
  ...
  async function registrarCentro(centro: NuevoCentroAcopio) {
    setAccionError(null);
  ...
  const showDesktopChat = isDesktop;
      ...
      <main className="relative min-h-0 flex-1 overflow-hidden">
        {(isDesktop || tab === "mapa") && (
          <div className="h-full">
            <Map centros={centros} onRegistrarCentro={registrarCentro} className="h-full" />
          </div>
        )}
